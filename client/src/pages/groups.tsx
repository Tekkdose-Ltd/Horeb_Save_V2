          ...
          {!isFullyVerified && (
            <Alert className="mb-6 border-amber-500/50 bg-amber-50 dark:bg-amber-950/20">
              ...
              <AlertDescription className="text-amber-800 dark:text-amber-200">
                <span className="font-semibold">Payment method required:</span> Link a card or bank account to join groups and make contributions.{" "}
                <Button
                  variant="link"
                  className="h-auto p-0 text-amber-700 dark:text-amber-300 underline font-semibold"
          ...
          {isFullyVerified && (
            <Alert className="mb-6 border-green-500/50 bg-green-50 dark:bg-green-950/20">
              ...
              <AlertDescription className="text-green-800 dark:text-green-200">
                <span className="font-semibold">Account verified:</span> You're all set to join and create groups!
              </AlertDescription>
            </Alert>
          )}
